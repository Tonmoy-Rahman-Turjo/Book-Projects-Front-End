...
const Bookcard = ({bookCard}) => {
    const {photourl, name, author, category, rating} = bookCard
               ...
               <div>
                ...
                <h2 className="mr-2 font-bese pb-2 font-bold text-[#724dfa] ">Rating:-<span className="ml-3 text-green-800">{rating}</span></h2>
                 ...
                 <div className="flex justify-center px-3 w-full " >
                    <button className="btn text-center bts text-white text-lg font-bold w-full bg-gradient-to-r from-[#518edf] to-[#f11fe7] mb-3 ">Update</button>
                 </div>
               </div>
            </div>
        </div>
